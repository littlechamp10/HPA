#include <lpccep.c_auto_to_lpc_line154_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <lpccep.c_auto_to_lpc_line154_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"lpccep.c_auto_to_lpc_line154_1.ptrderefout.hd", "lpccep.c_auto_to_lpc_line154_1.ptrderefout.st", "lpccep.c_auto_to_lpc_line154_1.ptrderefout.gl"};
    ...
    void* ptrCheckSumVal = dummy(4, a, alp, r, rc);
