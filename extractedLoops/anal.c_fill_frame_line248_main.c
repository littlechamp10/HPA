#include <anal.c_fill_frame_line248_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <anal.c_fill_frame_line248_1.h>
#include <common.h>
#include <timer.h>
...
struct fvec* restrict outbufptr;
struct fvec* restrict window;
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"anal.c_fill_frame_line248_1.ptrderefout.hd", "anal.c_fill_frame_line248_1.ptrderefout.st", "anal.c_fill_frame_line248_1.ptrderefout.gl"};
    ...
    {
        outbufptr = (struct fvec*) outbufptr_;
        window = (struct fvec*) window_;
        ...
        outbufptr->values = (float *)outbufptr_values_;
        memcpy(&outbufptr->length, &outbufptr_length_, sizeof(outbufptr_length_));
        window->values = (float *)window_values_;
    ...
    void* ptrCheckSumVal = dummy(3, inbufptr, outbufptr, window);
