#include <noise_est.c_det_line557_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <noise_est.c_det_line557_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"noise_est.c_det_line557_1.ptrderefout.hd", "noise_est.c_det_line557_1.ptrderefout.st", "noise_est.c_det_line557_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        memcpy(&Crband, &Crband_, sizeof(Crband_));
        memcpy(&output, &output_, sizeof(output_));
        filter = (struct fvec  *)filter_;
        buffer = (struct fmat  *)buffer_;
    ...
    void* ptrCheckSumVal = dummy(2, buffer, filter);
