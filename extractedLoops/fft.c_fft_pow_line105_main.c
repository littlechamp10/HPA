#include <fft.c_fft_pow_line105_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <fft.c_fft_pow_line105_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"fft.c_fft_pow_line105_1.ptrderefout.hd", "fft.c_fft_pow_line105_1.ptrderefout.st", "fft.c_fft_pow_line105_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        memcpy(&npoints, &npoints_, sizeof(npoints_));
        memcpy(&winlength, &winlength_, sizeof(winlength_));
    ...
    void* ptrCheckSumVal = dummy(1, temp);
