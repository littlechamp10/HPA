#include <lpccep.c_lpccep_line80_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <lpccep.c_lpccep_line80_1.h>
#include <common.h>
#include <timer.h>
...
struct fvec* restrict outptr;
struct fvec* restrict outptrOLD;
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"lpccep.c_lpccep_line80_1.ptrderefout.hd", "lpccep.c_lpccep_line80_1.ptrderefout.st", "lpccep.c_lpccep_line80_1.ptrderefout.gl"};
    ...
    {
        outptr = (struct fvec*) outptr_;
        outptrOLD = (struct fvec*) outptrOLD_;
        ...
        outptr->values = (float *)outptr_values_;
        memcpy(&outptr->length, &outptr_length_, sizeof(outptr_length_));
        outptrOLD->values = (float *)outptrOLD_values_;
    ...
    void* ptrCheckSumVal = dummy(2, outptr, outptrOLD);
