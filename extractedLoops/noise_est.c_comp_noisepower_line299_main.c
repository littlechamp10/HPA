#include <noise_est.c_comp_noisepower_line299_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <noise_est.c_comp_noisepower_line299_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"noise_est.c_comp_noisepower_line299_1.ptrderefout.hd", "noise_est.c_comp_noisepower_line299_1.ptrderefout.st", "noise_est.c_comp_noisepower_line299_1.ptrderefout.gl"};
    ...
    void* ptrCheckSumVal = dummy(2, buffer, pptr);
