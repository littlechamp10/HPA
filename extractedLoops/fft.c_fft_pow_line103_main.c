#include <fft.c_fft_pow_line103_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <fft.c_fft_pow_line103_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"fft.c_fft_pow_line103_1.ptrderefout.hd", "fft.c_fft_pow_line103_1.ptrderefout.st", "fft.c_fft_pow_line103_1.ptrderefout.gl"};
    ...
    void* ptrCheckSumVal = dummy(2, orig, temp);
