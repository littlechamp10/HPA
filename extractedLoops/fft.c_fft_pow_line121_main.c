#include <fft.c_fft_pow_line121_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <fft.c_fft_pow_line121_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"fft.c_fft_pow_line121_1.ptrderefout.hd", "fft.c_fft_pow_line121_1.ptrderefout.st", "fft.c_fft_pow_line121_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        memcpy(&npoints2, &npoints2_, sizeof(npoints2_));
    ...
    void* ptrCheckSumVal = dummy(2, power, temp);
