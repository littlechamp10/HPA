#include <lpccep.c_band_to_auto_line334_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <lpccep.c_band_to_auto_line334_1.h>
#include <common.h>
#include <timer.h>
...
struct fvec* restrict bandptr;
int j;
int n_freq;
struct fvec* restrict autoptr;
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"lpccep.c_band_to_auto_line334_1.ptrderefout.hd", "lpccep.c_band_to_auto_line334_1.ptrderefout.st", "lpccep.c_band_to_auto_line334_1.ptrderefout.gl"};
    ...
    {
        wcosptr = (double **) wcosptr_;
        bandptr = (struct fvec*) bandptr_;
        autoptr = (struct fvec*) autoptr_;

        memcpy(&n_freq, &n_freq_, sizeof(n_freq_));
        memcpy(&n_auto, &n_auto_, sizeof(n_auto_));
        bandptr = (struct fvec  *)bandptr_;
        autoptr = (struct fvec  *)autoptr_;
        ...
        bandptr->values = (float *)bandptr_values_;
        autoptr->values = (float *)autoptr_values_;
    ...
    void* ptrCheckSumVal = dummy(3, autoptr, bandptr, wcosptr);
