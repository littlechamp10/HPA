#include <noise_est.c_comp_noisepower_line288_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <noise_est.c_comp_noisepower_line288_1.h>
#include <common.h>
#include <timer.h>
...
struct fmat* restrict buffer;
int histo_step_framesize;
int i_call;
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"noise_est.c_comp_noisepower_line288_1.ptrderefout.hd", "noise_est.c_comp_noisepower_line288_1.ptrderefout.st", "noise_est.c_comp_noisepower_line288_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        memcpy(&histo_step_framesize, &histo_step_framesize_, sizeof(histo_step_framesize_));
        ...
        buffer->values = (float **)buffer_values_;
    ...
    void* ptrCheckSumVal = dummy(5, all_trajec, buffer, histo_index, histo_values, pptr);
