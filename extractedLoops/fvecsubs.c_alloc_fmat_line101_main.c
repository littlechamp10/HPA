#include <fvecsubs.c_alloc_fmat_line101_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <fvecsubs.c_alloc_fmat_line101_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"fvecsubs.c_alloc_fmat_line101_1.ptrderefout.hd", "fvecsubs.c_alloc_fmat_line101_1.ptrderefout.st", "fvecsubs.c_alloc_fmat_line101_1.ptrderefout.gl"};
    ...
    {
        mptr = (struct fmat*) mptr_;

        memcpy(&ncols, &ncols_, sizeof(ncols_));
        memcpy(&nrows, &nrows_, sizeof(nrows_));
        mptr = (struct fmat  *)mptr_;
        ...
        mptr->values = (float **)mptr_values_;
    ...
    void* ptrCheckSumVal = dummy(1, mptr);
