#include <fvecsubs.c_norm_fvec_line161_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <fvecsubs.c_norm_fvec_line161_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"fvecsubs.c_norm_fvec_line161_1.ptrderefout.hd", "fvecsubs.c_norm_fvec_line161_1.ptrderefout.st", "fvecsubs.c_norm_fvec_line161_1.ptrderefout.gl"};
    ...
    {
        fptr = (struct fvec*) fptr_;

        memcpy(&scale, &scale_, sizeof(scale_));
        fptr = (struct fvec  *)fptr_;
        ...
        fptr->values = (float *)fptr_values_;
        memcpy(&fptr->length, &fptr_length_, sizeof(fptr_length_));
    ...
    void* ptrCheckSumVal = dummy(1, fptr);
