#include <io.c_get_bindata_line485_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <io.c_get_bindata_line485_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"io.c_get_bindata_line485_1.ptrderefout.hd", "io.c_get_bindata_line485_1.ptrderefout.st", "io.c_get_bindata_line485_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        /*----------------- read data for buf----------------------*/
        char buf_dataFileName[] = "/dataFile/io.c_get_bindata_line485_1.buf.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/io.c_get_bindata_line485_1.buf.dat does not exist!");
                exit(-1);
            }
        ...
        memcpy(&nread, &nread_, sizeof(nread_));
        pptr = (struct param  *)pptr_;
        sptr = (struct fvec  *)sptr_;
